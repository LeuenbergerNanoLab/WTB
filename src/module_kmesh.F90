...
subroutine kpath2(outputfolder,rlat1,rlat2,rlat3,nks,ks,npts,kpt)
 ...
 if(Process==0) then
    ...
    kdisaux=0.0
    if(Process==0) write(1733,*) real(kdisaux)
...
subroutine kpath(outputfolder,rlat1,rlat2,rlat3,nks,ks,npts,kpt)
 ...
 if(Process==0) then
    ...
    if(Process==0) write(1733,*) real(0.0000)
    if(Process==0) write(1733,*) real(1.0000)
     continue
    end if
